...
bool Directx3D::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen,
	float screenDepth, float screenNear)
{
	HRESULT result;
	// DXGIFactory 사용하기 위한 인터페이스생성
	IDXGIFactory* factory;
	// 그래픽 카드 관련
	IDXGIAdapter* adapter;
	// 디스플레이 관련(해상도, Refresh Rate , Gamma Collection)
...
void Directx3D::GetProjectionMatrix(D3DXMATRIX& projectionMatrix)
{
...
void Directx3D::GetWorldMatrix(D3DXMATRIX& worldMatrix)
{
...
void Directx3D::GetOrthoMatrix(D3DXMATRIX& orthoMatrix)
{
